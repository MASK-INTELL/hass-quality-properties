...
export const metadata: Metadata = {
  title: 'Hass Quality Properties - Real Estate, Rentals & Vehicles in Fort Portal',
  ...
  openGraph: {
    title: 'Hass Quality Properties - Fort Portal Real Estate',
...
const localBusinessJsonLd = {
  ...
  description: 'Premier real estate company in Fort Portal Tourism City, Uganda specializing in houses, land, commercial properties, vehicles, and motorcycles.',
};
