...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with Hass Properties in Fort Portal Tourism City, Uganda. Call +256791715573, email hello@hassproperties.online, WhatsApp, or visit us to find your dream property.',
  openGraph: {
