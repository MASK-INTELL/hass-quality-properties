...
export default function AddProperty() {
  ...
  const inputClass = "w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all max-sm:text-base sm:text-sm";
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">Create a new listing for your website</p>
        </div>
      </div>
